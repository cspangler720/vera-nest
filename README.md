...
I do not intend the to make this compatible with a CNC router table. However, it would be possible by changing the padding calculation to match the appropriate bit diameter. The UI is AI-generated (leChat by Mistral) and was used for syntactic corrections.
